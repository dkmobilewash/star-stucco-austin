...
const localBusinessSchema = {
  ...
  areaServed: [
    ...
    { '@type': 'City', name: 'Westlake', containedInPlace: { '@type': 'State', name: 'Texas' } },
    ...
    { '@type': 'AdministrativeArea', name: 'Travis County, TX' },
    { '@type': 'AdministrativeArea', name: 'Williamson County, TX' },
    { '@type': 'AdministrativeArea', name: 'Bell County, TX' },
    { '@type': 'AdministrativeArea', name: 'Hays County, TX' },
    { '@type': 'AdministrativeArea', name: 'Burnet County, TX' },
    { '@type': 'AdministrativeArea', name: 'Comal County, TX' },
    { '@type': 'AdministrativeArea', name: 'Bastrop County, TX' },
    { '@type': 'AdministrativeArea', name: 'Llano County, TX' },
    { '@type': 'AdministrativeArea', name: 'Blanco County, TX' },
    { '@type': 'AdministrativeArea', name: 'Gillespie County, TX' },
    { '@type': 'AdministrativeArea', name: 'Caldwell County, TX' },
    { '@type': 'AdministrativeArea', name: 'Lee County, TX' },
    { '@type': 'AdministrativeArea', name: 'Milam County, TX' },
    { '@type': 'AdministrativeArea', name: 'Brazos County, TX' },
    { '@type': 'AdministrativeArea', name: 'McLennan County, TX' },
